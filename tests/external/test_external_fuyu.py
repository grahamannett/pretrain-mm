...
from transformers import FuyuForCausalLM as HFFuyuForCausalLM, FuyuProcessor as HFFuyuProcessor

from pretrain_mm import logger

from pretrain_mm.model.fuyu import CombineEmbeddings, FuyuProcessor as PatchedFuyuProcessor
...
class TestFuyuModel(unittest.TestCase):
    ...
    def test_vqa(self):
        ...
        model_inputs = processor(text=fourth_text_prompt, images=vacations_image_pil).to(model.device)
