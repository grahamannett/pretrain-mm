    ...
    def __call__(
        ...
        **kwargs,
        ...
        if text is not None and images is None:
            logger.warn("You are processing a text with no associated image. Make sure it is intended.")
        ...
        if text is None and images is not None:
            logger.warn("You are processing an image with no associated text. Make sure it is intended.")
            prompts = [[""]]
